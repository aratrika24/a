...
document.getElementById("product1").style.color="black";
document.getElementById("invent1").style.color="grey";
document.getElementById("invent1").style.backgroundColor="#f2f2f2";
document.getElementById("product1").style.backgroundColor="#b3b3b3";
if (x.style.display === "none") {
 ...
 document.getElementById("product1").style.color="grey";
 document.getElementById("invent1").style.color="black";
 document.getElementById("product1").style.backgroundColor="#f2f2f2";
 document.getElementById("invent1").style.backgroundColor="#b3b3b3";
  }
  }
	...
	<div class="col-lg-12" style="margin-left:40px;margin-top: 50px;">
			...
			<ul class="pill-list nav nav-pills  mb-9" id="pills-tab" role="tablist">
				<li class="pill-item nav-item">
					<a class="pill-link nav-link active" id="pills-prod-tab" data-toggle="pill" href="#prod" role="tab" aria-controls="prod" aria-selected="true" ><h2 style="text-align:left;font-size:30px;font-family: inherit;" id="product1" onclick="sendAjax()">view Submitted suppliers</h2></a>
				</li>
				<li class="pill-item nav-item">
					<a class="pill-link nav-link" id="pills-vend-tab" data-toggle="pill" href="#vend" role="tab" aria-controls="vend" aria-selected="false" ><h2 style="text-align:left; color:grey;font-size:30px;font-family: inherit;" onclick="sendAjax1()" id="invent1">view submitted contracts</h2></a>
				</li>
			</ul>
